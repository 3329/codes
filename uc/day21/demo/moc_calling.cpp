...
static const char qt_meta_stringdata_Calling[] = {
    "Calling\0\0logsig()\0"
};

const QMetaObject Calling::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Calling,
      qt_meta_data_Calling, 0 }
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Calling))
